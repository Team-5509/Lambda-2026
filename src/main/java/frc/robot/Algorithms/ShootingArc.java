...
public class ShootingArc {
    ...
    // TODO: verify the robots max velocity
    public static final double shooter_V_Max=30;// feet per second
        ...
        private final double gravity_in_ss = 386.088; // gravity in inches per second squared accelerated
