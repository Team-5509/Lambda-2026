...
public class Constants {
    public static class Vision {
        ...
        // Cam mounted facing forward, half a meter forward of center, quarter of a
        // meter up from center.
        public static final Transform3d kRobotToCam = new Transform3d(new Translation3d(0.5, 0.0, 0.25),
